...
public:
    ...
    void setGoalCurrent(unsigned char ID, int curr);
    void setNGoalCurrent(unsigned char ID, int curr);
    void setGoalPWM(unsigned char ID, unsigned int pwm);
    void setPGain(unsigned char ID, unsigned int p_gain);
    void setIGain(unsigned char ID, unsigned int i_gain);
    void setDGain(unsigned char ID, unsigned int d_gain);
    void setLimitPWM(unsigned char ID, unsigned int pwm);
    void setLimitCurrent(unsigned char ID, unsigned int cur);
    ...
    int writeSN(unsigned char ID, unsigned short addr, char *arr, int n);
